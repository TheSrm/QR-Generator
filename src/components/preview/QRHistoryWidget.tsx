        ...
        <div className="mt-4 rounded-xl border border-neutral-800/80 bg-neutral-950/60 p-3 transition">
            <div className="flex items-center justify-between">
                ...
                >
                    ...
                    <span>Historial reciente ({history.length})</span>
                </button>
            ...
            {isOpen && (
                <div className="mt-3 flex flex-wrap gap-2 pt-2 border-t border-neutral-900">
                    {history.map((item) => (
                        <button
                            key={item.id}
                            type="button"
                        ...
                        >
                            <span className="rounded bg-neutral-950 px-1.5 py-0.5 text-[10px] font-mono text-neutral-400 uppercase">
                                {item.type}
                            </span>
